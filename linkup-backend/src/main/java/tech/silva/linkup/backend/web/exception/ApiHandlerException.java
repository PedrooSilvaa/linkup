package tech.silva.linkup.backend.web.exception;
...
public class ApiHandlerException {
    ...
    @ExceptionHandler(LikeAlreadyMadeException.class)
    public ResponseEntity<ErrorMessage> likeAlreadyMadeException(RuntimeException ex, HttpServletRequest request){
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .contentType(MediaType.APPLICATION_JSON)
                .body(new ErrorMessage(request, HttpStatus.BAD_REQUEST, ex.getMessage()));
